...
public class InvitadoDTO {
    ...
    private Long idBoda;  // referencia solo por id para evitar anidamientos

    private List<Integer> idAlergias;  // solo ids de alergias
    private List<Long> idMesas;        // solo ids de mesas
